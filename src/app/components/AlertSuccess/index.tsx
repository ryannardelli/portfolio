...
export const AlertSucces = () => {
    ...
    <div
        className="max-w-sm w-full shadow-lg px-4 py-3 rounded relative bg-green-400 border-l-4 border-green-700 text-white">
        <div className="p-2">
            <div className="flex items-start">
                <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm leading-5 font-medium">
                    Sua mensagem foi recebida com sucesso! Responderei assim que possível.
                    </p>
                </div>
