export const Form = () => {
    return(
        <form className="-m-2 flex flex-wrap" action="https://api.staticforms.xyz/submit" method="POST">
        <input type="hidden" name="accessKey" value="b2bbbb43-a468-41f7-b926-decd407e8461"></input>
